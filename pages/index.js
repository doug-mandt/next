...
// Our Homepage component, will receive props from contentful entries thanks to getInitialProps function below. another comment
function HomePage(props) {
    return ( <
            ...
            div className = "columns" > {
                props.allPosts && props.allPosts.map(post => < Post post = { post }
